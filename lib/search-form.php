...
<form method="get" class="search-form  form-inline" action="%s" role="search">
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="search" class="search-field form-control-sm form-control" id="bfg-search-form" name="s" %s="%s">
...
function bfg_navbar_search_form($form, $search_text, $button_text, $label) {
    $value_or_placeholder = ( get_search_query() == '' ) ? 'placeholder' : 'value';
$format = <<<EOT
